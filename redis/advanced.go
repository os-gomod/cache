...
// CompareAndSwap atomically replaces a value when it matches oldVal.
...
// Increment atomically increments a counter stored at key.
...
// Decrement atomically decrements a counter stored at key.
