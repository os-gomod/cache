// Package redis provides options for the Redis cache.
package redis
...
// WithTimeouts sets dial, read, and write timeouts in one call.
...
// WithDistributedStampedeProtection enables a Redis lock around GetOrSet.
...
// WithConfig replaces the entire configuration (cloned immediately).
...
// MergeOptions builds a *config.Redis by applying opts onto DefaultRedis.
